...
// // Data baris pertama
// const firstRowData = document.createElement('tr');
// const instrukturCell = document.createElement('td');
// instrukturCell.style.verticalAlign = 'middle';
// instrukturCell.style.textAlign = 'center';
// instrukturCell.textContent = 'Ali';
// firstRowData.appendChild(instrukturCell);
// for (let i = 0; i < 14; i++) {
//     const kuisCell = document.createElement('td');
//     kuisCell.style.verticalAlign = 'middle';
//     kuisCell.style.textAlign = 'center';
//     kuisCell.textContent = '100';
//     firstRowData.appendChild(kuisCell);
// }
// const tugasCell = document.createElement('td');
// tugasCell.style.verticalAlign = 'middle';
// tugasCell.style.textAlign = 'center';
// tugasCell.textContent = '100'; // Nilai tugas
// firstRowData.appendChild(tugasCell);
// // Lanjutkan dengan sel-sel untuk UTS, UAS, Hasil, dan Action
// for (let i = 0; i < 4; i++) {
//     const emptyCell = document.createElement('td');
//     firstRowData.appendChild(emptyCell);
// }
// // Menambahkan baris pertama ke <tbody>
// tbody.appendChild(firstRowData);

// // Data baris kedua (sama seperti baris pertama, disesuaikan dengan data yang berbeda)
// const secondRowData = firstRowData.cloneNode(true);
// tbody.appendChild(secondRowData);

// // Menambahkan <tbody> ke tabel
// table.appendChild(tbody);
